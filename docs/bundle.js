...
var Logger = (function () {
    ...
    Logger.log = function (text, prefix, level) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__CanvasMap__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Logger__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Logger___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Logger__);
/**
 * Created by slava on 16/04/17.
 */
...
class UserInterface {
    ...
    static attachTabListeners() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-tab-link').on('click', (e) => {
            e.preventDefault();
            // Remove all isActive classes, hide all tabbed content
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-tab-link').removeClass('is-active');
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.tabbed-item').hide();
            // Add active class to the one clicked
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(e.target.parentNode).addClass('is-active');
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.' + __WEBPACK_IMPORTED_MODULE_0_jquery___default()(e.target.parentNode).attr('data-tab-target')).show();

        });
    }

    static toggleIsActiveClass(item) {
        let jItem = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(item);
    ...
    static attachSliderListeners() {
        // Scale slider
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#map_scale').on('input', (e) => {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-current-scale').html(e.target.value);
        });
        // Octaves
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#map_octaves').on('input', (e) => {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-current-octaves').html(e.target.value);
        });
        // Lacunarity
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#map_lacunarity').on('input', (e) => {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-current-lacunarity').html(e.target.value);
        });
        // Persistance
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#map_persistence').on('input', (e) => {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-current-persistence').html(e.target.value);
        });
    }
    ...
    addGenerateButtonListener() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-generate-map').on('click', (e) => {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-generate-map').addClass('is-loading');
            ...
            let seed = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#map_seed').val();
            let scale = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#map_scale').val();
            let octaves = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#map_octaves').val();
            let lacunarity = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#map_lacunarity').val();
            let persistence = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#map_persistence').val();

            let map = new __WEBPACK_IMPORTED_MODULE_1__CanvasMap__["a" /* default */](canvasId);
    ...
    static stopGenerateButtonLoading() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-generate-map').removeClass('is-loading');
    }
    ...
    static handleMapZoom(map) {
        ...
        const zoom = function (event) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.cur-x').html(x);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.cur-y').html(y);
        ...
        const updateZoomInfo = function(event){
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-clicked-x').html(x);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-clicked-y').html(y);
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-clicked-type').html(type);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-clicked-altitude').html(altitude);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-clicked-passable').html(passable.toString());
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-clicked-hasSettlement').html(settlement.toString());
    ...
    handlePopulateButtonClick(){
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-populate-map').on('click', () => {
            if (UI.currentMap){
    ...
    handleButtonRenderFull(){
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-render-full').on('click', () => {
            if (UI.currentMap){
                UI.currentMap.renderOnCanvas();
            } else {
                __WEBPACK_IMPORTED_MODULE_2__Logger___default.a.logError('No map present');
            }
        });
    }
}
/* harmony export (immutable) */ __webpack_exports__["default"] = UserInterface;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__UserInterface__ = __webpack_require__(2);
/**
 * Created by slava on 16/04/17.
 */
...
class CanvasHelper {
    ...
    static drawMap(map) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__UserInterface__["default"].stopGenerateButtonLoading();
    }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = MathsHelper;
...
var UserInterface_1 = __webpack_require__(2);
Logger_1.default.logGood('ha');
Logger_1.default.logError('Sample error');
// Start all UI related listeners
var ui = new UserInterface_1.default;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Tile__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TileTypes__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Generator__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__CanvasHelper__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__MathsHelper__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Logger__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Logger___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__Logger__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Colony__ = __webpack_require__(140);
/**
 * Created by slava on 16/04/17.
 */
...
class CanvasMap {
    ...
    constructor(canvasId) {
        ...
        for (let h = 0; h < this.height; h++) {
            ...
            for (let w = 0; w < this.width; w++) {
                this.tiles[h][w] = new __WEBPACK_IMPORTED_MODULE_0__Tile__["a" /* default */](w, h, __WEBPACK_IMPORTED_MODULE_1__TileTypes__["a" /* default */].DEEP_WATER, -5000);
            }
        }
    ...
    renderOnCanvas() {
        __WEBPACK_IMPORTED_MODULE_3__CanvasHelper__["a" /* default */].drawMap(this, this.canvasId);
    }

    generatePerlinBased(seed, scale, octaves, persistence, lacunarity, useFalloffMap = true) {

        const perlinMatrix = __WEBPACK_IMPORTED_MODULE_2__Generator__["a" /* default */].createPerlinNoiseMatrix(this.width, this.height, seed, scale, octaves, persistence, lacunarity);
        let falloffMatrix = [];
        if (useFalloffMap){
            falloffMatrix = __WEBPACK_IMPORTED_MODULE_2__Generator__["a" /* default */].createFalloffMap(this.width, this.height);
        }
        ...
        for (let h = 0; h < this.height; h++) {
            ...
            for (let w = 0; w < this.width; w++) {
                ...
                if (useFalloffMap){
                    ...
                    value = __WEBPACK_IMPORTED_MODULE_4__MathsHelper__["a" /* default */].clampNumber(subtracted);
                } else {
                ...
                this.tiles[h][w] = new __WEBPACK_IMPORTED_MODULE_0__Tile__["a" /* default */](w, h, __WEBPACK_IMPORTED_MODULE_0__Tile__["a" /* default */].getTypeByAltitude(altitude), altitude);
            }
        }
    ...
    addRandomColony(){
        ...
        let newColony = new __WEBPACK_IMPORTED_MODULE_6__Colony__["a" /* default */](x,y);
        randomTile.colony = newColony;
        this.colonies.push(newColony);

        __WEBPACK_IMPORTED_MODULE_3__CanvasHelper__["a" /* default */].drawMapPart(this, x-5, y-5, 10);

        __WEBPACK_IMPORTED_MODULE_5__Logger___default.a.logGood(`Settlement placed on X: ${x}, Y: ${y}`);
    ...
    addLargeRandomSettlement(size = 9){
        ...
        __WEBPACK_IMPORTED_MODULE_3__CanvasHelper__["a" /* default */].drawMapPart(this, startX -5, startY - 5, 20);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = CanvasMap;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CanvasHelper__ = __webpack_require__(120);
/**
...
class Colony {
    ...
    constructor(originX, originY){
        this.colour = __WEBPACK_IMPORTED_MODULE_0__CanvasHelper__["a" /* default */].getRandomColonyColour();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__MathsHelper__ = __webpack_require__(121);
/**
 * Created by slava on 16/04/17.
 */
...
const Noise = __webpack_require__(134).Noise;
    ...
    static createFalloffMap(width, height){
        ...
        for (let h = 0; h < height; h++) {
            ...
            for (let w = 0; w < width; w++) {
                ...
                falloffMap[h][w] = __WEBPACK_IMPORTED_MODULE_0__MathsHelper__["a" /* default */].evaluateFalloff(mapValue);
            }
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TileTypes__ = __webpack_require__(122);
/**
 * Created by slava on 16/04/17.
 */
...
class Tile {
    ...
    static getTypeByAltitude(altitude) {
        let type;
        let found = false;
        Object.keys(__WEBPACK_IMPORTED_MODULE_0__TileTypes__["a" /* default */]).forEach( key => {
            if (altitude <= __WEBPACK_IMPORTED_MODULE_0__TileTypes__["a" /* default */][key].maxAltitude && !found) {
                type = __WEBPACK_IMPORTED_MODULE_0__TileTypes__["a" /* default */][key];
                found = true;
            }
        });
